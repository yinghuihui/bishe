...
import com.rongdu.ow.core.module.domain.SysDict;
import com.rongdu.ow.core.module.domain.SysDictDetail;
import com.rongdu.ow.core.module.service.SysDictDetailService;
...
@Scope("prototype")
@Controller
public class SysDictController extends ManageBaseController {
	...
	@RequiresPermission(code = "/modules/manage/system/dict/page.htm",name = " 获取字典列表")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/findByTypeCode.htm",name = "获取字典详情列表")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/listByTypeCode.htm",name = "获取字典列表")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/listUpdateCode.htm",name = "修改时获取未使用字典列表")
...
//	@RequestMapping(value = "/modules/system/getDictDetail.htm")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/detail/find.htm",name = "字典详情")
...
//	@RequestMapping("/modules/system/addOrUpdateDict.htm")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/save.htm",name = "新增修改字典")
...
//	@RequestMapping("/modules/system/addOrUpdateDictDetail.htm")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/detail/save.htm",name = "新增修改字典详情")
...
//	@RequestMapping("/modules/system/deleteDict.htm")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/delete.htm",name = "删除字典")
...
//	@RequestMapping(value = "/modules/system/deleteDictDetail.htm")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/detail/delete.htm",name = "删除字典详情")
...
//	@RequestMapping(value = "/getDicts.htm")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/cache/list.htm",name = "缓存字典使用")
...
//	@RequiresPermission(code = "/modules/manage/system/dict/list.htm",name = "查询所有字典")
	...
	@RequiresPermission(code = "/modules/manage/system/dict/findAllByName.htm",name = "根据名称查询字典数据")
