...
var Region = React.createClass({
  ...
  render() {
    ...
    return (
      <div>     
          <Select size="large" style={{width:"130px",marginRight: "3px"}} disabled={citydisabe} name="Level0id"
        ...
        <Select size="large" style={{width:"130px",marginRight: "3px"}} disabled={citydisabe} name="Level1id"
         value={state.selectedCity} onChange={this._handleCityChange }>
           {this.state.city.map((v, k) => {
                return <Option key={k} value={String(v[0])}>{v[1]}</Option> 
              })}
        </Select>   
        <Select size="large" style={{width:"130px",marginRight: "3px"}} disabled={citydisabe} name="areaId"
