...
export default React.createClass({
	...
	fetch(data) {
        ...
        me.setState({
            ...
            value2: data.repaySource[1]['认证支付'],
            value3: data.repaySource[2]['支付宝APP支付'],
            value4: data.repaySource[3]['微信APP支付'],
            first: false
        },() => {
            me.drawPie();
        });
    ...
    drawPie() {
        ...
        var option = {
            ...
            legend: {
                ...
                x: 400,
                top: '30%',
                data: ['自动代扣', '认证支付', '支付宝APP支付','微信APP支付']
            },
            series: [{
                name: '还款方式',
                type: 'pie',
    ...
    render() {
        return <div id="pie2" style={{ height: '280px', width: '520px', margin: '0 auto' }}></div>
    }
});
