...
export default React.createClass({
  ...
  showModal(title, record, canEdit) {
    ...
    this.setState({
      ...
      if (title =="编辑" || title =="查看") {
        record.areaCodeName = record.areaCode; 
  ...
  fetch(params = {}) {
    ...
    Utils.ajaxData({
      url: '/modules/manage/voiceLocation/page.htm',
      data: params,
      callback: (result) => {
  ...
  delete(record) {
    ...
    confirm({
      ...
      onOk: function () {
        Utils.ajaxData({
          url: "/modules/manage/voiceLocation/delete.htm",
          data: {
            id: Number(record.id),
          },
          method: 'post',
  ...
  changeStatus(record,title) {
        ...
        confirm({
            ...
            onOk: function() {
                Utils.ajaxData({
                    url: '/modules/manage/voiceLocation/updateState.htm',
                    data: {
                        id: record.id,
                        state:status
                    },
