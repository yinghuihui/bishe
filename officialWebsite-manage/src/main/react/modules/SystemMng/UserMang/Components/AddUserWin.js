            ...
            <Row>
              <Col span="12">
	            <FormItem  {...formItemLayout}  label="手机号码:">
	              <Input disabled={!props.canEdit} {...getFieldProps('mobile',{ rules: [{validator: validatorFn.checkMobile, message: '请输入正确的手机号'}] })} type="text"/>
	            </FormItem>
	          </Col>
              <Col span="12">
            ...
            <Row>
              <Col span="12">
	            <FormItem  {...formItemLayout}  label="邮箱:">
	              <Input disabled={!props.canEdit} {...getFieldProps('email',{ rules: [{validator: validatorFn.checkEmail, message: '请输入正确的邮箱格式'}] })} type="text"/>
	            </FormItem>
	          </Col> 
              <Col span="12">
