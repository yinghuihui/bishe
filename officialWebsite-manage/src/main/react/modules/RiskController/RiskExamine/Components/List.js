                ...
                callback: (result) => {
                    if (result.code == 200) {
                        ...
                        if (result.data.userAuth) {
                            ...
                            if (result.data.userAuth.workInfoState == 10) {
                                dataForm.workInfoState = "未认证"
                            } else if (result.data.userAuth.workInfoState == 20) {
                                dataForm.workInfoState = "认证中"
                            } else if (result.data.userAuth.workInfoState == 30) {
                                dataForm.workInfoState = "已认证"
                            }
                        }
                        me.setState({
