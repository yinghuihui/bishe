    ...
    return (
          <Form horizontal form={this.props.form} style={{marginTop:'20'}}>
            ...
            <div className="navLine-wrap-left">
              ...
              <Row> */}
                <Col span="8">
                  <FormItem {...formItemLayout} label="身份证匹配地址：">
                    <Input {...getFieldProps('idNoMatchingAddr', { initialValue: '' }) } disabled={props.canEdit} />
                  </FormItem>
                </Col>
                </Row>
              <Row>
                <Col span="8">
                  <FormItem {...formItemLayout} label="手机号匹配地址：">
                    <Input {...getFieldProps('phoneMatchingAddr', { initialValue: '' }) } disabled={props.canEdit} />
                  </FormItem>
                </Col>
              </Row>
              {/**<h2>单位信息</h2>
              ...
              <Row>
                <Col span="8">
                  <FormItem {...formItemLayout} label="苹果手机验证：">
                    <Input {...getFieldProps('applePhoneState', { initialValue: '' }) } disabled={props.canEdit} />
                  </FormItem>
                </Col>
              </Row>
            </div>
