	...
	//文章列表
	$.ajax({
		url:"/modules/web/content/listbyprogramaid.htm?programaId=" + getid() + "&current=1&pageSize=5&remark=10",
		type:"get",
		dataType:"json",
				...
				require.async(['../../module/pager/pager.css','../../module/pager/pager'],function(){
					kkpager.generPageHtml({
							...
							click:function(n,total,totalRecords){
					        	$.ajax({
					        		type:"get",
					        		url:"/modules/web/content/listbyprogramaid.htm?programaId=" + getid() +"&current="+n+"&pageSize="+result.page.pageSize+"&remark=10",
