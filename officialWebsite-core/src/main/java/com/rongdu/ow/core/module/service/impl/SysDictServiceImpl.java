...
import com.rongdu.ow.core.module.mapper.SysDictDetailMapper;
import com.rongdu.ow.core.module.mapper.SysDictMapper;
...
public class SysDictServiceImpl implements SysDictService {
	...
	@Override
	public Map<String, String> getDictDetail(String typeCode) throws ServiceException {
		SysDict dict = this.findByTypeCode(typeCode);
		Map<String, Object> query = new HashMap<>();
		query.put("parentId", dict.getId());
		List<SysDictDetail> details = sysDictDetailMapper.listSelective(query);
		Map<String, String> result = new HashMap<>();
		for (SysDictDetail sysDictDetail : details) {
			result.put(sysDictDetail.getItemCode(), sysDictDetail.getItemValue());
		}
		return result;
	}
