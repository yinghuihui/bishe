...
//                int bit[] = new int[idcard17.length()];
	 ...
	 * @return
	 */
	public static String  doubleForm2(double numb){
		DecimalFormat df1 = new DecimalFormat("####.00");
		return df1.format(numb);
	}
	...
	public static boolean isName(String str) {
		String name = isNull(str);
		Pattern isName = Pattern.compile("^[\u4E00-\u9FA5]{2,5}$");
		Matcher matcher = isName.matcher(name);
		boolean isMatched = matcher.matches();
		return isMatched;
	}
