...
import com.rongdu.ow.core.module.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl extends BaseServiceImpl<SysConfig,Long> implements SysConfigService {
	...
	*/
	...
	@Override
	public List<SysConfig> getSysConfigByCode(Map<String, Object> map){
		return sysConfigMapper.getSysConfigByCode(map);
	}
	@Override
