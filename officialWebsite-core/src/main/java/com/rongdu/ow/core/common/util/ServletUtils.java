...
public class ServletUtils {
	 ...
	 * @param totalCount
	 */
	public static void writeToData(HttpServletResponse response,Object data) {
		//封装返回信息
	 ...
	 * @param totalCount
	 */
	public static void writeToResponse(HttpServletResponse response,Object data,long totalCount) {
		//封装返回信息
		Map<String,Object> returnMap = new HashMap<>();
		returnMap.put(Constant.RESPONSE_DATA, data);
	 ...
	 * @param response
	 */
	public static void writeToSuccess(HttpServletResponse response) {
		//成功消息
		Map<String,Object> returnMap = new HashMap<>();
		returnMap.put(Constant.RESPONSE_CODE, Constant.SUCCEED_CODE_VALUE);
		returnMap.put(Constant.RESPONSE_CODE_MSG, Constant.OPERATION_SUCCESS);
	...
	public static void printMsg(HttpServletResponse response, String msg) {
