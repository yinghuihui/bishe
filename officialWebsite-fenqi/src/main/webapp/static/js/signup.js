$(function() {
  ...
  var show_download = function(msg) {
    ...
    $('.yes').on('click', function() {
      window.location.href = "http://www.erongdu.com/index.html";
    });
  };
...
$('#button').click(function () {
  var data = {}, list = ['name', 'phone', 'idNo', 'money', 'remark'];
  var reg = /^1(3|4|5|7|8)\d{9}$/;
  ...
  $.ajax({
    ...
    data: data,
    success: function (data) {
      $("#req_data").val(JSON.stringify(data.req_data));
      $("#frm1").submit();
    },
  })
})
