define(function (require, exports, module) {
    ...
    //获取栏目
    var homeColumDown = function (pid) {
        var id = ""
        $.ajax({
            url: "/modules/web/programa/listbyparentid.htm",
            type: "get",
            data: { id: pid?pid:"0",remark:30},
            success: function (result) {
                var data = result.data
                console.log(result)
                for (var i = 0; i < data.length; i++) {
    ...
    var getAdvantage = function (id) {
        ...
        $.ajax({
            ...
            type: "get",
            data: { current: 1, pageSize: 4, programaId: id,remark:30},
            success: function (result) {
    ...
    var getProcess = function (id) {
        $.ajax({
            url: "/modules/web/content/sortbyprogramaid.htm",
            type: "get",
            data: { current: 1, pageSize: 6, programaId: id,remark:30},
            success: function (result) {
                var data = result.data.list;
                var str = "";
                for (var i = 0; i < data.length; i++) {
    ...
    var getProDown = function (id) {
        $.ajax({
            url: "/modules/web/content/sortbyprogramaid.htm",
            type: "get",
            data: { current: 1, pageSize: 2, programaId: id,remark:30},
            success: function (result) {
                var data = result.data.list;
                var str = "";
                for (var i = 0; i < data.length; i++) {
    ...
    var getAbUs = function (id) {
        ...
        $.ajax({
            url: "/modules/web/content/sortbyprogramaid.htm",
            type: "get",
            data: { current: 1, pageSize: 3, programaId: id,remark:30 },
            success: function (result) {
                var data = result.data.list;
                var str = "";
                for (var i = 0; i < data.length; i++) {
    ...
    var getNews = function () {
        ...
        $.ajax({
            ...
            type: "get",
            data: { programaId: id, current: 1, pageSize: 2,remark:30},
            success: function (result) {
                var str = "";
                var data = result.data.list;
                for (var i = 0; i < data.length; i++) {
    ...
    var getbulletin = function () {
        ...
        $.ajax({
            url: "/modules/web/content/listbyprogramaid.htm",
            type: "get",
            data: { programaId: id, current: 1, pageSize: 4,remark:30},
            success: function (result) {
                var str = "";
                var data = result.data.list;
                for (var i = 0; i < data.length; i++) {
    ...
    $.ajax({
        url: "/modules/web/content/sortbyprogramaid.htm",
        data:{remark:30,programaId:id,current:1, pageSize:10},
        type: 'get',
        success: function (result) {
