package com.rongdu.ow.controller.base;
...
import com.rongdu.ow.core.common.exception.ParamValideException;
...
import com.rongdu.ow.core.common.util.ValidateCode;
...
public abstract class BaseController extends AbstractController {
	...
	protected SysUser getLoginUser(HttpServletRequest request) {
		SysUser sysUser = (SysUser) request.getSession().getAttribute(Constant.SESSION_SYSUSER);
		return sysUser;
	}
...
//		logger.error("权限异常捕获：AuthorizationException:", e);
