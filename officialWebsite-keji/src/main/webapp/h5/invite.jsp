    ...
    <div class="signup seven">                          
        ...
        <div class="content">
            <form action="/api/user/wxRegister.htm">
                ...
                <%} %>
                <%if(agentCode != null&&!agentCode.equals("")&&!agentCode.equals("null")){ %>
                <div class='centerDiv'><input id='agentCode' name="agentCode" type="hidden" value="<%=agentCode%>"/></div>
                <%} %>
                ...
                <p class="clearfix other" >
                    ...
                    <label for="checkbox" onclick="click_a();" style="color:#000;">同意<a style="color:#000;" href="protocol_register.jsp">《使用协议》</a>
                          <i src="<%=basePath%>static/images/yes.png" id="click_a"></i>
                    </label> 
                     <a style="color:#000;" href="#">APP下载</a>                              
                </p>
            </form>
