...
<div class="reg-agreement">
  <div class="reg-wrap">
    <h1>用户注册协议</h1>
    <p>青年优品融资租赁有限公司在此郑重提示您，本文系您与“优品钱包”（以下简称平台）之间的法律协议，请您认真阅读并理解本协议，“优品钱包”为青年优品融资租赁有限公司旗下平台。您通过平台点击确认本协议的，即表示您同意遵循本协议的所有约定，本协议在您和平台之间具有法律约束力。如发生法律纠纷，您不得以未仔细阅读或理解本协议为由进行抗辩。
    </p>
    <h2>第一条  用户确认及服务接纳</h2>
    <p>1.1 注册用户需满足下列条件：</p>
    ...
    <h2>第八条  联系信息更新</h2>
    <p>用户接受平台服务期间，用户本人姓名、身份证号码、手机号码、银行账户等信息如发生变更，应当在相关信息发生变更之日起及时将更新后的信息提供给平台。因用户未能及时提供上述变更信息而带来的损失或额外费用应由用户自行承担。</p>
    <h2>第九条  适用法律及争议解决</h2>
    <p>9.1 本协议的签订、履行、终止、解释均适用中华人民共和国法律。</p>
    <p>9.2 因履行本协议所产生的争议应当通过友好协商解决；如协商不成，则本协议任意一方均可向平台所在地上海市杨浦区有管辖权的人民法院起诉。</p>
    <h2>第十条  其他</h2>
