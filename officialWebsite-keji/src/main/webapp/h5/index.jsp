...
<body class="probody">
  <div class="proView">
      <div class="proTop">
        ...
        <div class="noBtn">
          <a href="<%=basePath%>h5/invite.jsp?invitationCode=<%=invitationCode%>&channelCode=<%=channelCode%>&agentCode=<%=agentCode%>">
      ...
      <div class="proBtm">
        <div class="txtTop">
          ...
          <p>
                               优品钱包创立于2017年7月1日，是由宁波青年优品信息科技有限公司建立的一个安全、高效、诚信的线上APP金融平台，让您不再因钱而烦恼。
                               只需要一个手机，便可快速融资贷款，平台服务专业、处理及时、放款快捷、还款方便，为用户轻松解决资金问题。
          </p>
        </div>
        <div class="txtBtm">
          ...
          <ul>
            ...
            <li class="clearfix">
              ...
              <div class="txtBtmTxt">
                <h3>还款方式多样</h3>
                <p>支持支付宝还款，微信还款，自动代扣，还款方式多样，不用担心逾期带来的信用问题</p>
              </div>
            </li>
            <li class="clearfix">
        ...
        <a href="<%=basePath%>h5/invite.jsp?invitationCode=<%=invitationCode%>&channelCode=<%=channelCode%>&agentCode=<%=agentCode%>" class="regBtn-a">立即注册</a>
      </div>
  </div>
