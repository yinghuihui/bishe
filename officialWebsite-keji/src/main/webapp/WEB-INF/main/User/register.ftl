            ...
            <dl>
                ...
                <dd class="yanzheng validateCode">
                    ...
                    <div>
                        ...
                        <img id="yanzheng" src="${registerIp}/api/h5/imgCode/generate.htm" class="valicode_img" alt=""
                                            class="valicode_img" onclick="this.src='${registerIp}/api/h5/imgCode/generate.htm?t=' + Math.random();"
                                            align="absmiddle" />
                    </div>
                    <p class="msg_tip">
                    </p>
